    ...
    <el-carousel
      ...
      <el-carousel-item v-for="banner in bannerList"
        ...
        <a target="_blank" :href="banner.linkUrl">
          <img class="swiper-img" :src="banner.imageUrl" :alt="banner.title">
        </a>
      </el-carousel-item>
    </el-carousel>
    <!-- 幻灯片 结束 -->
  ...
  methods: {
    ...
    getBannerList() {
      banner.getListBanner()
        .then(resule => {
          this.bannerList = resule.data.data.data
        })
    },
    // 查询热门课程和讲师列表
    getIndexPage() {
      index.getIndexData()
        .then(resule => {
          this.courseList = resule.data.data.courseList
          this.teacherList = resule.data.data.teacherList
        })
    }
  }
}
