          ...
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <!--一级分类-->
                <li>
                  <a title="全部" href="javascript:void(0)" @click="homePage">全部</a>
                </li>
                <li
            ...
            <ol class="js-tap clearfix">
              <li :class="{'current bg-orange':buyCountSort!==''}">
                <a title="销量" href="javascript:void(0)" @click="searchByCount()">销量
                  <span :class="{hide:buyCountSort===''}">↓</span></a>
              </li>
              <li :class="{'current bg-orange':gmtCreateSort!==''}">
                <a title="最新" href="javascript:void(0)" @click="searchGmtCreate()">最新
                  <span :class="{hide:gmtCreateSort===''}">↓</span></a>
              </li>
  ...
  methods: {
    ...
    initSubject() {
      courseApi.getAllSubject()
        .then(resp => {
          this.subjectNestedList = resp.data.data.data
        })
    },
    // 分页切换的方法
    gotoPage(page) {
